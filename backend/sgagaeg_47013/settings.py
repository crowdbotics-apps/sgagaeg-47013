"""
Django settings for sgagaeg_47013 project.
...
ROOT_URLCONF = 'sgagaeg_47013.urls'
...
WSGI_APPLICATION = 'sgagaeg_47013.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sgagaeg_47013 API",
    "DESCRIPTION": "API documentation for sgagaeg_47013 App",
    "VERSION": "v1",
}
